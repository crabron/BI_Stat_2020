...
mice <- mice %>% 
  relocate(c(Genotype, Treatment, Behavior, class, ERBB4_N, BDNF_N), .after = Mouse) 
mice
...
Обрежем данные, уберём столбцы с большим количеством пропущенных значений

```{r}
mice_d <- mice %>% dplyr::select(-c(MouseID, Mouse, Genotype, Treatment, Behavior, class, ARC_N, BCL2_N , H3MeK4_N , BAD_N, EGR1_N, H3AcK18_N, pCFOS_N))
mice_d
```
